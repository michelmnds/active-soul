export const dances = [
  {
    ...
    "description": [
      "Esta aula pretende desenvolver a musicalidade, a flexibilidade, a coordenação de movimentos, a memória, a concentração e a técnica necessária para a dança clássica.",
      "Permite que exista uma melhor perceção corporal e amplia as noções de espaço.",
  ...
  },
  {
    ...
    "modality": "Adultos",
    "description": [
      "É uma aula a solo, dividida em 2 partes.",
  ...
  },
  {
    ...
    "description": [
      "Esta modalidade usa como base musical a música pop e comercial.",
  ...
  },
  {
    "id": 4,
    "name": "Dance Kids",
    "modality": "Aula dos 3 aos 8 anos",
    "description": [
      "Aula que contempla a realização de jogos com música, exercícios e coreografias adaptadas às diferentes faixas etárias.",
  ...
  },
  {
    "id": 5,
    "name": "Acro Dance",
    "modality": "Aula a partir dos 6 anos",
    "description": [
    ...
    "image": "https://i.imgur.com/SKbPBGG.jpg"
  },
  {
    "id": 6,
    "name": "Afro Latinas",
    ...
    "description": [
      "As afro-latinas, vertente social, é dançada a par e tem como objetivo explorar os conceitos como a conexão, fluxos de energia, peso e contrapeso, foco, musicalidade e interpretação.",
  ...
  },
  {
    ...
    "description": [
      "A Dança Contemporânea não apresenta uma técnica com uma linguagem única.",
