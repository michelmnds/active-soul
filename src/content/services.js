export const services = [
  {
    ...
    "title": "Agenciamento",
    "description": [
      "Os nossos bailarinos adaptam-se a todas as exigências e diversidades que o setor de eventos exige.",
      "Queres tornar o teu evento/espetáculo único e inesquecível? Os nossos bailarinos fazem-no com qualidade, profissionalismo e dedicação.",
  ...
  },
  {
    ...
    "title": "Casamentos",
    "description": [
      "Podem esperar a criação de uma coreografia personalizada, a respetiva edição musical e as aulas de preparação para a dança.",
      "O Active Soul dedica-se exclusivamente aos noivos.",
  ...
  },
  {
    ...
    "title": "Eventos",
    "description": [
      "• Espetáculos de Dança, Música, Teatro e Interação",
      "• Espetáculos Infantis",
      "• Eventos Privados e Corporativos",
    ...
    "packs": [
      {
        ...
        "includes": [
          "Duração de 1h30m;",
          "Animação com professor/a de dança (jogos musicais, coreografia simples e divertida);",
          "Apoio de staff para organização;",
          "Equipamento de som e luz necessário;",
          "A decoração do espaço é da responsabilidade dos pais;",
          "Disponibilizamos loiça decorativa para a sala de alimentação;",
          "Disponibilizamos mesas grandes, frigorífico e micro-ondas."
        ]
      },
      {
        "id": 2,
        ...
        "includes": [
          "Duração de 2h00;",
          "Animação temática (à escolha: dança, teatro e canto);",
          "Mini-aula + coreografia final com apresentação aos pais;",
          "Apoio de staff para organização;",
          "Equipamento de som e luz necessário;",
          "A decoração do espaço é da responsabilidade dos pais;",
          "Disponibilizamos loiça decorativa para a sala de alimentação;",
      ...
      {
        "id": 3,
        "name": "Pack Baby – 0 aos 5 anos",
        "includes": [
          "Duração de 1h00;",
          "Animação com professor/a de dança ou Professora de Mimo Musical;",
          "Apoio de staff para organização;",
          "Equipamento de som necessário;",
          "A decoração do espaço é da responsabilidade dos pais;",
          "Disponibilizamos loiça decorativa para a sala de alimentação;",
          "Disponibilizamos mesas grandes, frigorífico e micro-ondas;",
          "Podem permanecer os pais das crianças convidadas."
        ]
      },
      {
        "id": 4,
        "name": "Pack À minha Medida",
        "includes": [
          "Sob consulta"
        ],
        "extra": "Podem ainda optar apenas pelo *Aluguer de Sala*, sendo que nesta opção, a organização fica inteiramente à responsabilidade dos pais. "
      }
    ],
