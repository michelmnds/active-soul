    ...
    <Section>
      <div className="grid items-stretch gap-8 lg:grid-cols-[.8fr_1.2fr]">
        <div className="rounded-card bg-brand-950 p-8 text-white lg:p-10">
          <SectionHeading eyebrow="Visite-nos" title="Todos os caminhos vão dar ao Active Soul" lede={site.address} className="[&_h2]:text-white [&_p:last-child]:text-brand-200" />
